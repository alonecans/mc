   ...
   fahmi.on('chat-update', async (mek) => {
      try {
         ...
         if (isGroup) {
            try {
               ...
               if (getmemex <= memberLimit) {
                  fahmi.sendMessage(from, `*maaf manca-bot tidak bisa masuk group karna member group ${groupMetadata.subject} tidak memenuhi limit member*\n\n*minimal member ${memberLimit}*`, text);
                  setTimeout(() => {
                  ...
                  setTimeout(() => {
                     reply(`*maaf manca-bot segea keluar dari group ${groupMetadata.subject}*`);
                  }, 0);
               }
            } catch (err) {
               console.error(err);
         ...
         if (messagesLink.includes('@6283815956151')) {
            // respon tag ubah aja
            reply(`*maaf ${pushname2}, oᴡner manca-bot tidak meneima tag!*`);
...
͏͏͏͏͏͏͏͏͏͏͏͏͏͏      「 *_Mc-Bot Doᴡnload_* 」
...
<Manca Bot> By Nurul`,
                  ...
                  quoted: {
                     ...
                     message: {
                        imageMessage: {
                           ...
                           mimetype: 'image/jpeg',
                           caption: 'Instagram : @thenay_xploit_',
            ...
            case 'owner':
               ...
               fahmi.sendMessage(from, '*Tuh owner ku nama nya Nurul, jangan spam, di blok nanti nangis:V*', text, { quoted: mek });
               break;
            case 'fitnah':
               if (isBanned) return reply(mess.only.benned);
               if (!isUser) return reply(mess.only.userB);
            ...
            case 'tts':
               ...
               if (isLimit(sender)) return reply(limitend(pushname2));
               if (args.length < 1) return fahmi.sendMessage(from, 'Kode bahasanya mana kak?\n Kalo Gatau Kode Bahasanya Apa Aja Ketik Saja *${prefix}bahasa*', text, { quoted: mek });
               const gtts = require('./lib/gtts')(args[0]);
               if (args.length < 2) return fahmi.sendMessage(from, 'Textnya mana kak?', text, { quoted: mek });
               dtt = body.slice(9);
               ranm = getRandom('.mp3');
               rano = getRandom('.ogg');
               dtt.length > 600
            ...
            case 'report':
               ...
               fahmi.sendMessage('6283815956151@s.whatsapp.net', options, text, { quoted: mek });
            ...
            case 'fb':
               ...
               fahmi.sendMessage(from, buffer, video, { mimetype: 'video/mp4', quoted: mek, caption: 'Nih kak' });
               await limitAdd(sender);
               break;
            case 'instaimg':
               if (isBanned) return reply(mess.only.benned);
            ...
            case 'tiktokstalk':
               try {
                  ...
                  if (isLimit(sender)) return reply(limitend(pushname2));
                  if (args.length < 1) return fahmi.sendMessage(from, 'Usernamenya mana kak?', text, { quoted: mek });
            ...
            case 'ytmp4':
               ...
               fahmi.sendMessage(from, buffer, video, { mimetype: 'video/mp4', filename: `${anu.result.title}.mp4`, quoted: mek, caption: 'Nih kak' });
               await limitAdd(sender);
               break;
            ...
            case 'ytmp3':
               ...
               fahmi.sendMessage(from, buffer, audio, { mimetype: 'audio/mp4', filename: `${anu.result.title}.mp3`, quoted: mek, caption: 'Nih kak' });
               await limitAdd(sender);
               break;
            ...
            case 'smule':
               ...
               buffer = await getBuffer(anu.result);
               fahmi.sendMessage(from, buffer, video, { mimetype: 'video/mp4', filename: `${anu.title}.mp4`, quoted: mek, caption: 'Nih kak' });
               await limitAdd(sender);
               break;
            ...
            default:
               if (body.startsWith(`${prefix}${command}`)) {
                  ...
                  conts loli = fs.readFileSync('./mp3/hai.mp3')
                  fahmi.sendMessage(from, loli, MessageType.audio, { quoted: amv, ptt: true })
